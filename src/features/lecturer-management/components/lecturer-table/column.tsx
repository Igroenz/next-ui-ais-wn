...
import { lecturerColumnVisibility } from "../../policy";
...
const LecturerColumn = ({ role, onEdit, onDelete }: LecturerColumnProps) => {
  const visibility = lecturerColumnVisibility[role as keyof typeof lecturerColumnVisibility];
  const columns: ColumnDef<LecturerWithUserAndMajor>[] = [];
